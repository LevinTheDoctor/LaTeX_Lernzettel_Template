...
Regionale Datenschutzvorgaben verlangen, dass Daten \emph{physisch} in
...
Eine \textbf{Sovereign Cloud} schützt personenbezogene Daten, geistiges
...
% LEKTORAT (Redundanz): Die vier Architektur-Domänen werden bereits im Kapitel
% "Cloud Architektur" (TOGAF) erklärt und hier daher nicht wiederholt, sondern
% nur referenziert. Fokus dieses Abschnitts ist der Compliance-Aspekt.
\textbf{Governance} beschreibt die Fähigkeit eines Unternehmens, Anwendungen
unternehmensweit zu steuern, Compliance nachzuweisen und Risiken zu
kontrollieren -- über vordefinierte Prinzipien, Gremien und Reviews. Im
Datenschutz-Kontext sorgt Daten-Governance dafür, dass Daten regelkonform
abgelegt und verarbeitet werden. Die zugehörigen vier Architektur-Domänen
(Geschäfts-, Anwendungs-, Daten- und Technologiearchitektur) sind im Kapitel
\enquote{Cloud Architektur} beschrieben.

\subsection{Personenbezogene Daten}
Daten, die eine \emph{natürliche Person} identifizieren oder identifizierbar machen, sind \textbf{personenbezogene Daten}. Besonders schützenswert (besondere Kategorien nach Art.~9 DSGVO) sind Angaben zur rassischen oder ethnischen Herkunft, politische Meinung, religiöse oder weltanschauliche Überzeugung, Gewerkschaftszugehörigkeit, sexuelle Orientierung, Gesundheitsdaten sowie genetische und biometrische Daten. Daten von Kindern unter 16~Jahren dürfen nur mit Einwilligung der Eltern verarbeitet werden. Personenbezogene Daten können anonymisiert werden.