...
Oben wurde nur ein einzelnes Beispiel genannt, was durch Cloud-Migration möglich ist. In realen Umgebungen gibt es jedoch mehrere wichtige Use Cases für eine Cloud-Migration. Diese werden häufig als die \enquote{6~R\,s} der Migration zusammengefasst.
