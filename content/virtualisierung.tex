...
Eine Virtual Private Cloud (VPC) ist ein logisch isoliertes
Netzwerksegment innerhalb einer öffentlichen Cloud-Infrastruktur.
Obwohl die physische Hardware mit anderen Kunden geteilt wird,
verhält sich eine VPC wie ein eigenes privates Netzwerk: mit
eigenen IP-Bereichen, Subnetzen, Routing-Regeln und Firewalls.
Der Zugriff von außen wird über klar definierte Gateways und
Security Groups kontrolliert.